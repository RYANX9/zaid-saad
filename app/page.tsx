  ...
  return (
    <main className="bg-[var(--black)] text-[var(--white)] min-h-screen relative">
      ...
      >
        ...
        <button
          onClick={toggleTheme}
          className="font-[family-name:var(--font-space-mono)] text-[9px] tracking-[0.18em] uppercase text-[var(--gray)] border border-[var(--gray)]/40 rounded-full px-4 py-[7px] hover:text-[var(--white)] hover:border-[var(--white)] transition-colors duration-200 cursor-pointer"
          onMouseEnter={() => setCursorHover(true)}
          onMouseLeave={() => setCursorHover(false)}
        >
      ...
      <section className="relative h-screen min-h-[700px] flex flex-col justify-end px-7 md:px-[52px] pb-[72px] overflow-hidden">
        ...
        >
          <div className="font-[family-name:var(--font-space-mono)] text-[10px] tracking-[0.22em] uppercase text-[var(--gray)] mb-7 flex items-center gap-[18px]">
            <span className="block w-9 h-[3px] rounded-full bg-[var(--accent)]" />
          ...
          <div className="flex items-end justify-between gap-12 flex-wrap">
            ...
            <div className="flex gap-3.5">
              <a
                href="#work"
                className="font-[family-name:var(--font-space-mono)] text-[10px] tracking-[0.16em] uppercase px-7 py-3.5 rounded-full border-2 border-[var(--accent)] bg-[var(--accent)] text-[var(--accent-ink)] hover:bg-transparent hover:text-[var(--white)] transition-all duration-250"
                onMouseEnter={() => setCursorHover(true)}
                onMouseLeave={() => setCursorHover(false)}
              >
                View Work
              ...
              <a
                href="#contact"
                className="font-[family-name:var(--font-space-mono)] text-[10px] tracking-[0.16em] uppercase px-7 py-3.5 rounded-full border-2 border-[var(--gray)]/35 text-[var(--gray)] bg-transparent hover:border-[var(--white)] hover:text-[var(--white)] transition-all duration-250"
                onMouseEnter={() => setCursorHover(true)}
                onMouseLeave={() => setCursorHover(false)}
              >
                Contact
      ...
      <div ref={bandRef} className="grid grid-cols-1 md:grid-cols-3 border-b border-[var(--white)]/[0.06]">
        {stats.map((s, i) => (
          ...
          >
            <span
              className="font-[family-name:var(--font-unbounded)] font-bold leading-none tracking-[-0.03em] text-[var(--white)] block mb-2.5"
              style={{ fontSize: "68px" }}
            >
              {s.num}
            </span>
      ...
      <section id="about" className="py-[120px] px-7 md:px-[52px] max-w-[1400px] mx-auto">
        ...
        >
          <span className="block w-7 h-[3px] rounded-full bg-[var(--accent)]" />
          01 — About
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-[100px] items-start">
          ...
          >
            <h2
              className="font-[family-name:var(--font-unbounded)] font-black leading-[1.0] tracking-[-0.025em] uppercase text-[var(--white)] mb-10"
                ...
                >
                  ...
                  <div className="flex flex-col gap-[7px] pt-1 relative z-10">
                    {p.tags.map((t) => (
                      <span
                        key={t}
                        className="font-[family-name:var(--font-space-mono)] text-[8px] tracking-[0.14em] uppercase text-[var(--gray)] border-[1.5px] border-[var(--gray)]/45 rounded-full px-3 py-[5px] w-fit transition-all duration-200 group-hover:border-[var(--accent)] group-hover:text-[var(--white)]"
                      >
                        {t}
                      </span>
                    ))}
                  ...
                  >
                    {p.linkLabel}
                    {p.link && (
                      <span className="inline-block text-[var(--accent)] transition-transform duration-250 group-hover:translate-x-[3px] group-hover:-translate-y-[3px]">
                        ↗
                      </span>
                    )}
                  </div>
      ...
      <section id="contact">
        <div className="py-[140px] px-7 md:px-[52px] max-w-[1400px] mx-auto">
          <h2
            ...
            className={`font-[family-name:var(--font-unbounded)] font-black leading-[0.92] tracking-[-0.03em] uppercase text-[var(--white)] mb-[100px] transition-all duration-[800ms] ${
